...
export default class App extends Component {
    ...
    state = {
        percentage:0.2 , //to obtained form firebase as a part of long term analysis 
        health_message:null, 
        color_cond:"", 
        act_message:""
    }
    ...
    updateMessage = () =>{
        if (this.state.percentage<=0.2){
            this.setState({
                ...
                color_cond: "#e60909", 
                act_message:"Keep jumping to prevent your pet from getting sick !"
            })
        }
            ...
            this.setState({
                ...
                color_cond:"#eaf51b",
                act_message:"Keep jumping to see improvement on the health status of your cat !"
            })
        }
        else  {
            this.setState({
                ...
                color_cond:"#1bf543",
                act_message:"You are jumping well !!          Keep going !!"
            })
        }
        }
        componentDidMount() {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Image source={require('../assets/cat-jumping.gif')} style={styles.image} />
