...
export default class App extends Component {
    ...
    state = {
        percentage:0.92, //to obtained form firebase as a part of long term analysis 
        health_message:null, 
        color_cond:"", 
        act_message:""
    ...
    updateMessage = () =>{
        if (this.state.percentage<=0.2){
            this.setState({
                ...
                color_cond: "#e60909", 
                act_message:"Keep walking to prevent your pet from getting sick !"
            })
        }
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Image source={require('../assets/cat-walking.gif')} style={styles.image} />
